...
$classes_query = mysqli_query($conn, "
    ...
    FROM classes 
    WHERE class_teacher = '$teacher_id'
    ORDER BY class_name
");
...
<div class="layout">
    ...
    <div class="sidebar">
        ...
        <a href="enter_marks.php" class="active">Enter Marks</a>
    ...
    <div class="main">
        ...
        <?php if ($success_message): ?>
            ...
            <script>
                setTimeout(() => {
                    window.location.href = 'enter_marks.php?class_id=<?= htmlspecialchars($class_id) ?>&subject_id=<?= htmlspecialchars($subject_id) ?>';
                }, 1500);
            </script>
        <?php endif; ?>
        ...
        <div class="section">
            <p class="info">
                Entering marks for a student who already has marks will update the existing record.
            </p>
            ...
            <form method="POST">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="number" 
                                       name="marks[<?= $student['student_id'] ?>][test]" 
                                       min="0" max="20" 
                                       required>
                            </td>
                            <td>
                                <input type="number" 
                                       name="marks[<?= $student['student_id'] ?>][assignment]" 
                                       min="0" max="20" 
                                       required>
                            </td>
                            <td>
                                <input type="number" 
                                       name="marks[<?= $student['student_id'] ?>][exam]" 
                                       min="0" max="60" 
                                       required>
                            </td>
                        </tr>
                ...
                <div class="action-area">
                    <button type="submit" name="save_marks" class="btn">
                        Save All Marks
                    </button>
                </div>
            </form>
        ...
        <?php elseif ($class_id && $subject_id): ?>
            <div class="section">
                <p style="color:#e74c3c; text-align:center; font-size:1.1rem;">
